...
1. Приложение возможно использовать на русском и английском языках.

2. В случае сбоя должна быть возможность восстановить все данные старше 24 часов.

3. Приложение должно реагировать на любой пользовательский запрос не дольше, чем в течение 1 секунды при одновременном обращении 10 000 пользователей.

4. Приложение должно в пике выдерживать обращение 50 000 пользователей при этом отвечать на запросы не дольше, чем за 5 секунд.

5. Приложение должно быть доступно 99.9% времени в год.
