...
Диаграмма представлена в файле containers.plantuml.
...
Диаграммы представлены в файлах components-backend.plantuml и components-frontend.plantuml соответственно.
...
Диаграмма представлена в файле sequence.plantuml.
...
Диаграмма базы данных представлена в файле database.plantuml.
